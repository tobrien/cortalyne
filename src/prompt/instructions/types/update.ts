...
Task #1 - Organize information from the raw transcript about an update that the dictator has about a topic or a project.

Task #2 - Analyze the transcript and determine if this update is a continuation of a previous update, or if this is a new update.

Task #3 - If the update is about a project, a person, a place, or a thing, please identify what this update is related to in another field.

Task #4 - When reading the transcript look to directions to do research into this update and identify information that might need to be gathered to further develop the update.
...
- If the update is brief, capture it as concise bullet points.
- If detailed or lengthy, summarize it clearly in paragraphs, ensuring no critical information is omitted.
- Use sections and bullet points if the update is detailed and lengthy or if the update has multuple parts and sections.

The update note should also make sure to capture all of the thoughts, ideas, emotions, feelings, and information shared in the transcript being careful not to change the meaning or content of the transcript as it is written.   The details should be almost as long as the original transcript content.
