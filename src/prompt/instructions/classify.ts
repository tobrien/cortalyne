import { Instruction, Section, createInstruction, createSection } from "@tobrien/minorprompt";
...
export const IDENTIFY_NOTE_TYPES_SECTION = `
...
export const IDENTIFY_SECTIONS_SECTION = `
...
export const IDENTIFY_CONFERENCE_TOOL_SECTION = `
...
export const IDENTIFY_SUBJECT_SECTION = `
...
export const IDENTIFY_PEOPLE_SECTION = `
...
export const IDENTIFY_TASKS_SECTION = `
...
export const create = async (configDir: string, { generateOverrideContent }: { generateOverrideContent: (configDir: string, overrideFile: string) => Promise<{ override?: string, prepend?: string, append?: string }> }): Promise<(Instruction | Section<Instruction>)[]> => {
    ...
    if (overrideContent.override) {
        ...
        const outputSection = createSection<Instruction>("Output Format");
        outputSection.add(OUTPUT_FORMAT_SECTION);
        instructions.push(outputSection);

        const noteTypesSection = createSection<Instruction>("How to Identify Note Types");
        noteTypesSection.add(IDENTIFY_NOTE_TYPES_SECTION);
        instructions.push(noteTypesSection);

        const sectionsSection = createSection<Instruction>("How to Identify Sections");
        sectionsSection.add(IDENTIFY_SECTIONS_SECTION);
        instructions.push(sectionsSection);

        const conferenceToolSection = createSection<Instruction>("How to Identify Conference Tool");
        conferenceToolSection.add(IDENTIFY_CONFERENCE_TOOL_SECTION);
        instructions.push(conferenceToolSection);

        const subjectSection = createSection<Instruction>("How to Identify the Subject");
        subjectSection.add(IDENTIFY_SUBJECT_SECTION);
        instructions.push(subjectSection);

        const peopleSection = createSection<Instruction>("How to Identify People in a Meeting or Call");
        peopleSection.add(IDENTIFY_PEOPLE_SECTION);
        instructions.push(peopleSection);

        const tasksSection = createSection<Instruction>("How to Identify Tasks");
        tasksSection.add(IDENTIFY_TASKS_SECTION);
